...
describe('Analytics Model - Ticket #1', () => {
  ...
  describe('getStockoutRate', () => {
    it('should calculate stockout rate with lost revenue', async () => {
      ...
      expect(result[0].lost_revenue).toBe(1500.00);
  ...
  describe('getDashboardMetrics', () => {
    it('should aggregate all dashboard metrics', async () => {
      ...
      const stockoutData = [{ total_stockout_rate: 3.2, total_lost_revenue: 5000 }];
      const carryingData = [{ total_carrying_cost: 10000, avg_carrying_percentage: 5.5 }];
