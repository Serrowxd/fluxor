...
describe("ConflictResolutionEngine - Ticket #3", () => {
  ...
  describe("detectConflicts", () => {
    it("should detect stock mismatches between channels", async () => {
      ...
      const conflicts = await ConflictResolutionEngine.detectConflicts(
        productId
      );
  ...
  describe("getResolutionHistory", () => {
    it("should retrieve conflict resolution history", async () => {
      ...
      const history = await ConflictResolutionEngine.getResolutionHistory(
        productId,
        days
      );
  ...
  describe("analyzeConflictPatterns", () => {
    it("should identify conflict patterns for optimization", async () => {
      ...
      const patterns = await ConflictResolutionEngine.analyzeConflictPatterns(
        storeId,
        period
      );
      ...
      const conflict = {
        ...
        channels: [
          ...
          },
          {
            ...
            quantity: 90,
            reliability_score: 0.7, // Lower reliability
          },
        ],
      };
